...
var serviceAccountKey_json_1 = __importDefault(require("../services/serviceAccountKey.json"));
admin.initializeApp({
    credential: admin.credential.cert(serviceAccountKey_json_1.default),
});
var pushNotification = function (registrationToken, payload, res) { return __awaiter(void 0, void 0, void 0, function () {
